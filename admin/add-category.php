<?php 
  ...
  $StateObject->AddProductCategory();

  $StateObject->DeleteDate('pro_category',@$_GET['cId']);
          ...
          <div class=" flex w-full items-center  justify-between flex-col md:flex-row " >
            <div class="w-[100%] sm:w-[48%] ">
             <label class="block mt-4 text-sm">
              ...
              placeholder="Category Name" type="" name="categoryName">
            </label>
          </div>
        </div>
        ...
        <div class="w-full overflow-x-auto">
          <table class="w-full whitespace-no-wrap">
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
              <?php echo $StateObject->ViewProductCategory(); ?>
            </tbody>
          </table>
        </div>
