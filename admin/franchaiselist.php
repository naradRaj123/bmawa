...
$FranchaisObj->DeleteFranchaise(@$_GET['del_id']);
...
//   } else {
//     header('location:franchaiselist.php?status=error');
//   }  
// }
  ...
  <main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
      <div class=" flex items-center justify-between ">
        ...
        <a href="add-franchaise.php">
          <!-- <button class="bg-[#7e3af2] p-2 rounded-md text-white px-3 ">Add Members</button> -->
        </a>
      </div>
      <!-- New Table -->
        ...
        <div class="w-full overflow-x-auto">
          <table class="w-full whitespace-no-wrap">
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
              ...
              <?php $FranchaisObj->ViewFrancaiseList(); ?>
